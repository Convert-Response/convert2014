...
function joints_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // easy pie charts
    wp_enqueue_script( 'easypie-js', get_template_directory_uri() . '/library/js/jquery.easypiechart.min.js', array( 'jquery' ), '', true );   
   
    // waypoints
    wp_enqueue_script( 'waypoints', get_template_directory_uri() . '/library/js/waypoints.min.js', array( 'jquery' ), '', true );      
 
    // big video
    wp_enqueue_script( 'tubular', get_template_directory_uri() . '/library/js/jquery.tubular.1.0.js', array( 'jquery' ), '', true );
    wp_enqueue_script( 'videojs', get_template_directory_uri() . '/library/js/video.js', array( 'jquery' ), '', true );    
    ...
    // register convert stylesheet
    wp_enqueue_style( 'convert-stylesheet', get_template_directory_uri() . '/library/css/convert.css', array(), '', 'all' );
    ...
    wp_enqueue_style( 'animation', get_template_directory_uri() . '/library/css/animate.css', array(), '', 'all' );
    
    // register video background stylesheet
    wp_enqueue_style( 'bgvideo', get_template_directory_uri() . '/library/css/bigvideo.css', array(), '', 'all' );    
