...
register_nav_menus(
	array(
		...
		'mobile-main-nav' => __( 'The Mobile Main Menu' ),   // main nav in header		
...
function joints_mobile_main_nav() {
	// display the wp3 menu if available
    wp_nav_menu(array(
    	'container' => false,                           // remove nav container
    	'container_class' => '',           // class of container (should you choose to use it)
    	'menu' => __( 'The Mobile Main Menu', 'jointstheme' ),  // nav name
    	'menu_class' => '',         // adding custom nav class
        ...
        'link_before' => '',                            // before each link
        'link_after' => '',                             // after each link
    	'fallback_cb' => 'joints_mobile_main_nav_fallback'      // fallback function
	));
} /* end joints main nav */
...
function slide_contact() {
	echo do_shortcode('[contact-form-7 id="240" title="Home Contact"]');	
}
...
<div id="our-process" class="show-for-large-up" name="our-process">
	<div class="row process-buttons">
		<div id="process-1" class="large-3 columns button-wrap active"><a class="process-btn">Strategize</a></div>
		<div id="process-2" class="large-3 columns button-wrap"><a class="process-btn">Launch</a></div>
		<div id="process-3" class="large-3 columns button-wrap"><a class="process-btn">Analyze</a></div>
		<div id="process-4" class="large-3 columns button-wrap"><a class="process-btn">Refine</a></div>			
	</div>
	<div class="row">
			...
			<div id="icons">
				<div class="row">		
					...
					<div class="large-4 columns">
						<div class="row">			
							<div id="icon-1" class="large-12 columns icon"><i class="icon-c_strategize"></i></div>
							<div id="icon-2" class="large-12 columns icon"><i class="icon-c_launch"></i></div>		
							<div id="icon-3" class="large-12 columns icon"><i class="icon-c_analyze"></i></div>
							<div id="icon-4" class="large-12 columns icon"><i class="icon-c_refine"></i></div>	
						</div>							
					</div>
...
<!-- 			<br><br><br><br><h1>Our Process</h1> -->
			<div class="row">
				<div id="process-1-text" class="large-12 columns process-text"><h1>Strategize</h1></div>
				<div id="process-2-text" class="large-12 columns process-text"><h1>Launch</h1></div>
				<div id="process-3-text" class="large-12 columns process-text"><h1>Analyze</h1></div>
				<div id="process-4-text" class="large-12 columns process-text"><h1>Refine</h1></div>			
			</div>		
			<div class="row">
...
<div id="our-process-mobile" class="hide-for-large-up" name="our-process">
	<div class="row">
		<div class="process-wrap">			
			<div id="process-1-text" class="medium-12 columns process-text"><h1><span id="icon-1" class="icon"><i class="icon-c_strategize"></i></span>Strategize</h1></div>	
			<div id="process-1-body" class="large-12 columns process-body"><br><?php echo the_field('strategy_text');?></div>
		</div>	
		<div class="process-wrap">				
			<div id="process-2-text" class="medium-12 columns process-text"><h1><span id="icon-2" class="icon"><i class="icon-c_launch"></i></span>Launch</h1></div>	
			<div id="process-2-body" class="large-12 columns process-body"><br><?php echo the_field('live_testing_text');?></div>
		</div>	
		<div class="process-wrap">						
			<div id="process-3-text" class="medium-12 columns process-text"><h1><span id="icon-3" class="icon"><i class="icon-c_analyze"></i></span>Analyze</h1></div>
			<div id="process-3-body" class="large-12 columns process-body"><br><?php echo the_field('marketing_text');?></div>
		</div>
		<div class="process-wrap">				
			<div id="process-4-text" class="medium-12 columns process-text"><h1><span id="icon-4" class="icon"><i class="icon-c_refine"></i></span>Refine</h1></div>	
			<div id="process-4-body" class="large-12 columns process-body"><br><?php echo the_field('integration_text');?></div>	
		</div>		
	</div>
</div>
